...
remote_cofig = {
    "network_config": "https://game-config.hypergryph.com/api/remote_config/get_remote_config/3/prod-cbt/default/default/network_config",
    "game_config": "https://game-config.hypergryph.com/api/remote_config/get_remote_config/3/prod-cbt/default/default/game_config",
    "res_version": "https://game-config.hypergryph.com/api/remote_config/get_remote_config/3/prod-cbt/default/default/res_version",
    "server_config": "https://game-config.hypergryph.com/api/remote_config/get_remote_config/3/prod-cbt/default/default/server_config_China",
...
async def check_update() -> UpdateCheckResult:
    ...
    for key, url in remote_cofig.items():
        ...
        path = get_res_path("ArknightsUID") / f"{key}.json"
        if not path.exists():
